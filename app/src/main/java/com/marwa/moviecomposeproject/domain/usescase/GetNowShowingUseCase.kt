...
class GetNowShowingUseCase(private val movieRepository: IMovieRepository) {
    suspend fun execute(): Flow<NetworkResource<MovieResponse>>  = movieRepository.getRemoteNowShowingMovies()
}